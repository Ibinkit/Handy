...
pub fn change_post_process_enabled_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    ...
    // The post-processing binding has no key of its own here: cleanup runs on
    // the dictation shortcut and follows this setting at transcription time.
    // Unregister defensively so a key left over from an older build goes away.
